        ...
        <div class="card-body text-center">
            <div class="list-menu">
                ...
                <div class="item-menu text-center">
                    ...
                    <div class="menu-name">
                        <span class="text-center">Pengajuan Izin</span>
                    </div>
                </div>
                <div class="item-menu text-center">
                    <div class="menu-icon">
                        <a href="/presensi/histori" class="blue" style="font-size: 40px;">
    ...
    <div id="rekappresensi">
        ...
        <div class="row">
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-success" style="position: absolute; top:3px; right:10px; font-size:0.6rem; z-index:999">{{ $rekappresensi->jmlhadir }}</span>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-success" style="position: absolute; top:3px; right:10px; font-size:0.6rem; z-index:999">{{$rekappresensi->jmltepatwaktu}}</span>
                        <ion-icon name="ribbon-outline" style="font-size: 1.6rem;" class="text-warning mb-1"></ion-icon>
                        <br>
                        <span style="font-size: 0.8rem; font-weight:500">Tepat Waktu</span>
                    </div>
                </div>
            </div>
            <div class="col-3">
