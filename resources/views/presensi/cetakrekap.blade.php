...
<body class="A4 landscape">
    ...
    <section class="sheet padding-10mm">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 30px">z
                    <img src="{{ asset('assets/img/login/logocetak.png') }}" width="80" height="80" alt="">
                </td>
                <td>
                    <span id="title">
                    ...
                    <span><i>Jl. Pemuda No.171, Sekayu, Kec. Semarang Tengah, Kota Semarang, Jawa Tengah 50132</i></span>
                </td>
            </tr>
        </table>
